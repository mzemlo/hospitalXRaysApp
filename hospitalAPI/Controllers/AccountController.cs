    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> SetPassword(SetPasswordBindingModel model)
        {
            ...
            if (removePassword.Succeeded)
            {
                ...
                var AddPassword = await UserManager.AddPasswordAsync(model.UserId, model.NewPassword);
            ...
            //IdentityResult result = await UserManager.ChangePasswordAsync(model.UserId, user.PasswordHash, model.NewPassword);
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            {
                return BadRequest("Logowanie zewnętrzne jest już skojarzone z kontem.");
            }
        ...
        //[Authorize(Roles = "Ordynator, Admin")]
        [AllowAnonymous]
        [Route("Register")]
        ...
        public async Task<IHttpActionResult> Edit(EditBindingModel model)
        {
            ...
            currentUser.Contract = model.Contract;
        ...
        private IHttpActionResult GetErrorResult(IdentityResult result)
        {
            ...
            if (!result.Succeeded)
            {
                ...
                if (ModelState.IsValid)
                {
                    // Brak dostępnych błędów elementu ModelState do wysłania, więc zwróć pusty element BadRequest.
                    return BadRequest();
                }
        ...
        private static class RandomOAuthStateGenerator
        {
            ...
            public static string Generate(int strengthInBits)
            {
                ...
                {
                    throw new ArgumentException("Wartość strengthInBits musi być podzielna przez 8.", "strengthInBits");
                }
